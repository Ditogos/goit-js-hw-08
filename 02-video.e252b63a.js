...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ef(t)||0,es(n)&&(s=!!n.leading,i=(f="maxWait"in n)?eu(ef(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(el())},m}(e,t,{leading:r,maxWait:t,trailing:o})};const ed=new Q("vimeo-player",{id:19231868,width:640});ed.on("play",function(){console.log("played the video!")}),ed.on("play",function(e){var t;let n={duration:e.duration,percent:e.percent,seconds:e.seconds},r=((t=B)&&t.__esModule?t.default:t)(eh,1e3);r(n)});const eh=function(e){localStorage.setItem("videoplayer-current-time",JSON.stringify(e))},ep=localStorage.getItem("videoplayer-current-time");if(ep){let e=JSON.parse(ep),{seconds:t}=e;ed.setCurrentTime(t).then(function(e){console.log("Pozition video: ",e,"sekonds")}).catch(function(e){"RangeError"===e.name?console.error("The time was less than 0 or more than the duration of the video"):console.error("Happend another error",e)})}//# sourceMappingURL=02-video.e252b63a.js.map

//# sourceMappingURL=02-video.e252b63a.js.map
